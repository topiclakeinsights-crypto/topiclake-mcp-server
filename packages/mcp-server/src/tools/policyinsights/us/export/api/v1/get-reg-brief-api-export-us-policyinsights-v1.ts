...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/policyinsights/us/export/api/v1/reg_brief',
  operationId: 'reg_brief_policyinsights_us_export_api_v1_reg_brief_get',
};

export const tool: Tool = {
  name: 'get_reg_brief_api_export_us_policyinsights_v1',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nBased on the summaries generated by our TopiclakeAI, the AI provides concise document briefs and key insights. Useful in creating annotated data networks, summarizing information, and enhancing search optimizations. Each Insight can be traced back to its parent Federal Register Document for verification.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/v1_get_reg_brief_response',\n  $defs: {\n    v1_get_reg_brief_response: {\n      type: 'object',\n      title: 'RegBriefResponse',\n      properties: {\n        count: {\n          type: 'integer',\n          title: 'Count'\n        },\n        current_page: {\n          type: 'integer',\n          title: 'Current Page'\n        },\n        message: {\n          type: 'string',\n          title: 'Message'\n        },\n        next_page: {\n          type: 'integer',\n          title: 'Next Page'\n        },\n        previous_page: {\n          type: 'integer',\n          title: 'Previous Page'\n        },\n        status: {\n          type: 'string',\n          title: 'Status'\n        },\n        topic_lake_insight_data: {\n          type: 'array',\n          title: 'Topic Lake Insight Data',\n          items: {\n            type: 'object',\n            title: 'RegBriefData',\n            properties: {\n              id: {\n                type: 'string',\n                title: 'Id'\n              },\n              created_at: {\n                type: 'string',\n                title: 'Created At',\n                format: 'date-time'\n              },\n              document_id: {\n                type: 'string',\n                title: 'Document Id'\n              },\n              document_name: {\n                type: 'string',\n                title: 'Document Name'\n              },\n              document_number: {\n                type: 'string',\n                title: 'Document Number'\n              },\n              reg_brief: {\n                type: 'object',\n                title: 'Reg Brief',\n                additionalProperties: true\n              },\n              updated_at: {\n                type: 'string',\n                title: 'Updated At',\n                format: 'date-time'\n              }\n            },\n            required: [              'id',\n              'created_at',\n              'document_id',\n              'document_name',\n              'document_number',\n              'reg_brief',\n              'updated_at'\n            ]\n          }\n        },\n        total_count: {\n          type: 'integer',\n          title: 'Total Count'\n        },\n        total_pages: {\n          type: 'integer',\n          title: 'Total Pages'\n        }\n      },\n      required: [        'count',\n        'current_page',\n        'message',\n        'next_page',\n        'previous_page',\n        'status',\n        'topic_lake_insight_data',\n        'total_count',\n        'total_pages'\n      ]\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      id: {
...
export const handler = async (client: TopiclakeMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.policyinsights.us.export.api.v1.getRegBrief(body)),
  );
};
