...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/policyinsights/us/export/api/v1/summary',
  operationId: 'summary_policyinsights_us_export_api_v1_summary_get',
};

export const tool: Tool = {
  name: 'get_summary_api_export_us_policyinsights_v1',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nBased on the Atoms(Topics) generated by our TopiclakeAI, three types of summaries are generated on the topic. Useful in creating your own knowledge base and training data. Each Summary can be traced back to its parent Federal Register Document for verification\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/v1_get_summary_response',\n  $defs: {\n    v1_get_summary_response: {\n      type: 'object',\n      title: 'SummaryResponse',\n      properties: {\n        count: {\n          type: 'integer',\n          title: 'Count'\n        },\n        current_page: {\n          type: 'integer',\n          title: 'Current Page'\n        },\n        message: {\n          type: 'string',\n          title: 'Message'\n        },\n        next_page: {\n          type: 'integer',\n          title: 'Next Page'\n        },\n        previous_page: {\n          type: 'integer',\n          title: 'Previous Page'\n        },\n        status: {\n          type: 'string',\n          title: 'Status'\n        },\n        summary_data: {\n          type: 'array',\n          title: 'Summary Data',\n          items: {\n            type: 'object',\n            title: 'SummaryData',\n            properties: {\n              id: {\n                type: 'string',\n                title: 'Id'\n              },\n              created_at: {\n                type: 'string',\n                title: 'Created At',\n                format: 'date-time'\n              },\n              document_id: {\n                type: 'string',\n                title: 'Document Id'\n              },\n              document_name: {\n                type: 'string',\n                title: 'Document Name'\n              },\n              document_number: {\n                type: 'string',\n                title: 'Document Number'\n              },\n              long_summary: {\n                type: 'string',\n                title: 'Long Summary'\n              },\n              short_summary: {\n                type: 'string',\n                title: 'Short Summary'\n              },\n              title: {\n                type: 'string',\n                title: 'Title'\n              },\n              topiclake_topic_id: {\n                type: 'string',\n                title: 'Topiclake Topic Id'\n              },\n              updated_at: {\n                type: 'string',\n                title: 'Updated At',\n                format: 'date-time'\n              }\n            },\n            required: [              'id',\n              'created_at',\n              'document_id',\n              'document_name',\n              'document_number',\n              'long_summary',\n              'short_summary',\n              'title',\n              'topiclake_topic_id',\n              'updated_at'\n            ]\n          }\n        },\n        total_count: {\n          type: 'integer',\n          title: 'Total Count'\n        },\n        total_pages: {\n          type: 'integer',\n          title: 'Total Pages'\n        }\n      },\n      required: [        'count',\n        'current_page',\n        'message',\n        'next_page',\n        'previous_page',\n        'status',\n        'summary_data',\n        'total_count',\n        'total_pages'\n      ]\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      id: {
...
export const handler = async (client: TopiclakeMcpServer, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(
    await maybeFilter(jq_filter, await client.policyinsights.us.export.api.v1.getSummary(body)),
  );
};
