import fs from 'fs';
import type { ResponseLike } from 'topiclake-mcp-server/internal/to-file';
import { toFile } from 'topiclake-mcp-server/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('topiclake-mcp-server/core/uploads');
    await expect(
